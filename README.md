...
**Status:** `1.2.0`, published on Packagist. Depends on `monad/clarity ^1.0`, which
currently resolves to `1.8.0`. The two packages have independent version lines; each
